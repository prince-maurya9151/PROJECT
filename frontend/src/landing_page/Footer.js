...
function Footer() {
  return ( 
    ...
    <div className='contianer border-top mt-5 p-5' >
      ...
      <div className='col'>
        ...
        <a href='' style={{textDecoration:"none", color: "grey"}}>Rferal Programme</a><br/>
      ...
      <div className='col'>
      <p>Support</p><br/>
      <a href='' style={{textDecoration:"none", color: "grey"}}>Contact</a><br/>
      ...
      <p>Account</p><br/>
        ...
        <a href='' style={{textDecoration:"none", color: "grey"}}>Fund tranfer</a><br/>
        <a href='' style={{textDecoration:"none", color: "grey"}}>60 day challenge</a><br/>
      </div>
